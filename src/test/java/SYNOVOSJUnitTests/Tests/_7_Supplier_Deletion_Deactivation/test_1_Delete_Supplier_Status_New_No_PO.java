package SYNOVOSJUnitTests.Tests._7_Supplier_Deletion_Deactivation;
...
public class test_1_Delete_Supplier_Status_New_No_PO {
    ...
    @Test
    public void deleteSupplierWithStatusNew(){
        ...
        Assert.assertEquals("Search Suppliers", matchingSupplierListPage.headerTextMatching.getText()); // It means that supplier with status New was Deleted successfully
        //Search Suppliers
    }
}
