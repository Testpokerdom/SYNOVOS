...
public class SupplierCreateAndReject {
    ...
    public static final Logger logger = LogManager.getLogger(SupplierCreateAndReject.class);
    ...
    public void test_1_Create_Supplier(){
        ...
        createSupplierPage.fillUserDataTableAndSendForApproval("Supplier_status_REJECTED_DEMO_SALES_", "","999-999-9999", "@ukr.net", "Send_for_approval_test_creation");
        clickButton(createSupplierPage.buttonOKpopup);
        logger.info("Created Supplier number is: " + getTextFronWebElement(supplierDetailPage.fieldSupplierNumber));
        logger.info("------------------------------------------------------");
    ...
    public void test_2_Reject_Supplier(){
