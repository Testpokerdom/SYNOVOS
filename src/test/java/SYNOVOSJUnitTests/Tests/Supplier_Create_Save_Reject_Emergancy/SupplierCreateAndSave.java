...
public class SupplierCreateAndSave {
    ...
    public static Logger logger = LogManager.getLogger(SupplierCreateAndSave.class);
    ...
    @Test
    @Description("Create Supplier, don't sand for approval - just save current Supplier")
    @DisplayName("Create Supplier, don't sand for approval - just save current Supplier")
    public void test_1(){

        clickButton(mainPageLocators.linkSupplier);
        selectWebElementFromDropDownList(supplierSearchCreatePage.dropdownListSiteCode, "SALES");
        clickButton(supplierSearchCreatePage.buttonCreate);
        createSupplierPage.fillUserDataTableAndSave("Supplier_status_NEW_DEMO_SALES_", "","999-999-9999", "@ukr.net", "Send_for_approval_test_creation");
        logger.info("Supplier was saved, his number is: " + getTextFronWebElement(supplierDetailPage.fieldSupplierNumber) + " Supplier status is New.");
        logger.info("------------------------------------------------------");
