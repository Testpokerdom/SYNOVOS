package SOS.Tests._4_Supplier_Activity_Status;
...
public class RejectedSupplierStatusShouldBeInActive {
...
*/
    ...
    @Test
    //@Description ("RejectedSupplierStatusShouldBeInActive")
    //@DisplayName("RejectedSupplierStatusShouldBeInActive")
    public void test_3_Rejected_Supplier_Status_Should_Be_InActive(){
        ...
        findLastRawInTableAndClick2(driver, "//table[@id='supplier']/tbody/tr[1]/td[last()]/a[@title='Edit Supplier']");
