...
public class Rejected_Supplier_Status_Should_Be_InActive {
    ...
    @Test
    //@Description ("Rejected_Supplier_Status_Should_Be_InActive")
    //@DisplayName("Rejected_Supplier_Status_Should_Be_InActive")
