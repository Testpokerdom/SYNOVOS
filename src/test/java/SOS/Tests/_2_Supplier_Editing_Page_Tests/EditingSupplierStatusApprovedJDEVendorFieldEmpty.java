...
public class EditingSupplierStatusApprovedJDEVendorFieldEmpty {
    ...
    public void test_4_ChangeJDEVendorForSupplierWithStatusApproved(){
        ...
        Assert.assertEquals("You have one or more errors on the page. Please fix these errors before submitting this form.", editSupplierPage.headerErorMessage.getText());
        Assert.assertEquals("Required", editSupplierPage.fieldJDEVendorErrorMessage.getText());
