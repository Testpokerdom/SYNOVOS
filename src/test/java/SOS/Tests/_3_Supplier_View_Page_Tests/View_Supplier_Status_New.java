...
public class View_Supplier_Status_New {
    ...
    public void createSupplierWithStatusNew(){
        ...
        Assert.assertTrue(WebHelpers.getTextFromWebElement(supplierDetailPage.fieldApprovalNotes).contains("04/22/2019 VBIBIKSU: Supplier with status New was send for approve from Supplier Detail page"));
    }
}
