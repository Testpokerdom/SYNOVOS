...
public class Test_4_ApprovePaymentTermForSupplierStatusEmergency {
...
*/
    ...
    public void createSupplierEmergency(){
        ...
        Assert.assertEquals("Emergency", supplierDetailPage.fieldApprovalStatus.getText());

        clickButtonIfEnable(supplierDetailPage.buttonEdit);
        Assert.assertTrue(editSupplierPage.buttonSendForApprovalPaymentTerms.isEnabled() == false); //Emergency supplier could not be sent for Peyment Terms approval
